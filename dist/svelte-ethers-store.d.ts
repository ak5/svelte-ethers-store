 ...
 */
declare const chainData: DefaultEVMStore['chainData'];
...
export { ChainData, DefaultEVMStore, allChainsData, chainData, chainId, connected, contracts, defaultEvmStores, provider, selectedAccount, signer, signerAddress };
